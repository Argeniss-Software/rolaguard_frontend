      ...
      <div className="app-body-container-view">
        ...
        <div className="animated fadeIn animation-view dashboard">
          ...
          <div className="view-body">
            <div>
              <Form className="form-label form-css-label text-center" onSubmit={this.handleSubmit} noValidate="novalidate" style={{ marginTop: "2em" }}>
                <Form.Field required>
                  <Form.Input
                    required
                    name="username"
                  ...
                  {this.state.showErrors.usernameInvalid && (
                    <Label className="mt0" basic color="red" pointing>
                      Invalid User Name. Please enter at least 3 characters, a maximum of 32 characters, use only letters (a-z), numbers, periods or underscores. 
                    </Label>
                  )}
              ...
              {createOK && (
                <Label className="text-center mh-auto" basic color='green'>{'The user has been successfully created. A link to activate the account has been emailed.'} </Label>
              )}
              {unknownError && (
                <Label className="text-center mh-auto" basic color='red'>We are sorry. It has been an error while trying to create the user.</Label>
              )}
            </Form>
          </div>
        </div>
