                ...
                <div className="table-container-box">
                  <Segment>
                      {showFilters && (
                        ...
                        {tagsFeatureFlag && assets.some((asset) => asset.selected) &&
                          <div style={{display: "flex", position: "relative", float: "right"}} className="range-select" onClick={() => alert("Work in progress")}>
